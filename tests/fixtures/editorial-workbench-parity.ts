...
export const approvedEditorialInventories = {
  ...
  sidebarViews: inventory([
    'book-selection', 'benchmark', 'person-assets', 'queue', 'history', 'image-lab', 'voice-lab', 'music-mv',
    'viral-analyzer', 'prompt-templates', 'draft-templates', 'settings', 'account', 'activation', 'html-video',
  ...
  createTaskInputFields: inventory([
    ...
    'podcastSpeakerA', 'podcastSpeakerB', 'coverImageMode', 'coverTemplateId', 'htmlVideoForeground',
...
export const approvedConceptVisibleCopy = {
  ...
  'history/active/light/1440x900': ['历史任务', '搜索任务', '状态', '进度', '输出'],
  'task-detail/default/light/1440x900': ['任务详情', '流水线', '产物预览', '分镜画廊', '配音试听'],
