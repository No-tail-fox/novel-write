...
export const storyDreamApi: StoryDreamApi = {
  ...
  getVoxAnimationRuntime: () => invokeTrusted('vox:runtime'),
  compileVoxAnimation: (source) => invokeTrusted('vox:compile', source),
  generateVoxAnimation: (input) => invokeTrusted('vox:generate', input),
  cancelVoxAnimation: (id) => invokeTrusted('vox:cancel', id),
  readVoxAnimationAsset: (path) => invokeTrusted('vox:asset', path),
  listVoxTemplates: () => invokeTrusted('vox:templates-list'),
  saveVoxTemplate: (input) => invokeTrusted('vox:templates-save', input),
  deleteVoxTemplate: (id) => invokeTrusted('vox:templates-delete', id),
  cancelDirectorRender: (id) => invokeTrusted('director:cancel-render', id),
  exportVoxAnimationShot: (input) => invokeTrusted('vox:export-shot', input),
  ...
  openProviderPortal: (url: string): Promise<void> => invokeTrusted('provider:open-portal', url),
