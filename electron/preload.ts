...
export const storyDreamApi: StoryDreamApi = {
  ...
  fetchHotBoard: (): Promise<HotBoardSnapshot> => invokeTrusted('hotboard:fetch'),
  queryAiHot: (input: AiHotQueryRequest): Promise<AiHotQueryResult> => invokeTrusted('aihot:query', input),
