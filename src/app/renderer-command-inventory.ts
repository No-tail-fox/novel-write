...
export const rendererCommandInventory = {
  ...
  archiveImageLabRecord: command(owner('history', 'src/features/tasks/HistoryPage.tsx', 'archiveRecord', 'archiveRecord(record)', '归档', historyTest)),
  archiveTask: command(owner('history', 'src/features/tasks/HistoryPage.tsx', 'archiveRecord', 'archiveRecord(record)', '归档', historyTest)),
  archiveViralAnalysis: command(owner('history', 'src/features/tasks/HistoryPage.tsx', 'archiveRecord', 'archiveRecord(record)', '归档', historyTest)),
  ...
  openTaskOutputDirectory: command(
    ...
    owner('history', 'src/features/tasks/HistoryPage.tsx', 'openHistoryOutput', 'openHistoryOutput(record.id)', '打开输出目录', 'tests/electron-ipc-contract.test.ts'),
    ...
    owner('queue', 'src/features/tasks/QueuePage.tsx', 'openQueueOutput', 'openQueueOutput(latestTask.id)', '打开剪映草稿', 'tests/electron-ipc-contract.test.ts'),
  ...
  restoreImageLabRecord: command(owner('history', 'src/features/tasks/HistoryPage.tsx', 'restoreRecord', 'restoreRecord(record)', '恢复', historyTest)),
  restoreTask: command(owner('history', 'src/features/tasks/HistoryPage.tsx', 'restoreRecord', 'restoreRecord(record)', '恢复', historyTest)),
  restoreViralAnalysis: command(owner('history', 'src/features/tasks/HistoryPage.tsx', 'restoreRecord', 'restoreRecord(record)', '恢复', historyTest)),
  restoreVoiceLabRecord: command(owner('history', 'src/features/tasks/HistoryPage.tsx', 'restoreRecord', 'restoreRecord(record)', '恢复', historyTest)),
  retryTask: command(
  ...
  updateTaskStatus: command(
    ...
    owner('task-detail', 'src/features/tasks/TaskDetailPage.tsx', 'cancelTask', 'onClick={cancelTask}', '取消任务', 'tests/task-operations-contracts.test.ts'),
  ),
