...
export const rendererCommandInventory = {
  ...
  composeResearchCopy: command(
    ...
    owner(
      ...
      'onClick={createHtmlVideoTask}',
      'aiCreateActionLabel',
      'tests/html-video-page-workflow.test.ts',
      'src/features/html-video/HtmlVideoPage.tsx',
      { disabled: 'disabled={taskBusy || !createInputReady}', loading: "createPhase === 'compose'", error: 'InlineActionFeedback' },
      'src/features/html-video/HtmlVideoPage.tsx',
      undefined,
      bridgeChain(['src/features/html-video/HtmlVideoPage.tsx', 'createHtmlVideoResearchCopy(api']),
    ),
  ),
  ...
  searchWebSources: command(
    ...
    owner(
      ...
      'tests/html-video-page-workflow.test.ts',
      'src/features/html-video/HtmlVideoPage.tsx',
      { disabled: 'disabled={taskBusy || !createInputReady}', loading: "createPhase === 'search'", error: 'InlineActionFeedback' },
      'src/features/html-video/HtmlVideoPage.tsx',
      undefined,
      bridgeChain(['src/features/html-video/HtmlVideoPage.tsx', 'createHtmlVideoResearchCopy(api']),
    ),
