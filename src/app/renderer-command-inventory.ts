...
export const rendererCommandInventory = {
  ...
  createEditorialCollage: command(owner(
    ...
    undefined,
    { disabled: 'disabled={!createTitle.trim() || !createSource.trim() || projectAction.busy}', loading: 'projectAction.busy ? <Loader2', error: 'AsyncActionFeedback' },
  )),
  createMotionComic: command(owner(
    ...
    undefined,
    { disabled: 'disabled={!createTitle.trim() || !createPremise.trim() || projectAction.busy}', loading: 'projectAction.busy ? <Loader2', error: 'AsyncActionFeedback' },
  )),
  ...
  saveEditorialCollage: command(owner(
    'editorial-collage',
    'src/features/editorial-collage/EditorialCollagePage.tsx',
    'saveProject',
    ...
    'tests/editorial-collage-workbench.test.ts',
    undefined,
    { disabled: 'disabled={!document || !dirty || projectAction.busy}', loading: 'projectAction.busy ? <Loader2', error: 'AsyncActionFeedback' },
  )),
  saveMotionComic: command(owner(
    'motion-comic',
    'src/features/motion-comic/MotionComicPage.tsx',
    'saveProject',
    'onClick={() => void saveProject()}',
